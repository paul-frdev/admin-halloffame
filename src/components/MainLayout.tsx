    ...
    <Layout>
      ...
      <Layout className='side-layout'>
        <Header style={{ background: colorBgContainer }} className='flex justify-between p-0 pr-4'>
          ...
          />
          <div className="flex gap-x-4 items-center relative cursor-pointer" onClick={() => setVisible(prev => !prev)}>
            <div>
              <img
                width={32}
                height={32}
            ...
            <div className={cn(`absolute top-[66px] left-0 shadow-md rounded-md bg-white w-[230px]`, visible ? 'visible ' : 'hidden')}>
